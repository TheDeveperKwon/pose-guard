...
| 문서 | 용도 | 링크 |
| --- | --- | --- |
| Project Overview (EN) | Repository structure and shared workflows | [README.md](./README.md) |
| 프로젝트 개요 (KO) | 저장소 구조, 공통 실행 방법 | **현재 문서** |
...
- 자세한 사용법: [apps/desktop/README.ko.md](./apps/desktop/README.ko.md)
...
- 자세한 운영 가이드: [apps/web/README.ko.md](./apps/web/README.ko.md)
